 ...
 */
class LookUpFirstSpiritApiResourcePlugin extends AbstractPlugin implements FirstSpiritApiResourcePluginInterface, OptionsForItemInterface
{
    /**
     * @var string
     */
    protected const RESOURCE_NAME = 'lookup-url';
    ...
    public function find(FirstSpiritApiRequestTransfer $apiRequestTransfer): FirstSpiritApiCollectionTransfer
    {
        return $this->getFacade()
            ->getIdentifierByUrl($apiRequestTransfer);
    }
